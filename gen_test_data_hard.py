...
if __name__ == '__main__':
    ...
    for vid_ann in vid_paths:
        ...
        for vid_frame in vid_frames:
            ...
            cv2.imwrite(os.path.join(args.out_path, vid_class, vid_fname, str(vid_frame)), image)
            ...
            # plt.savefig(os.path.join(args.out_path, 'plots', vid_class, vid_fname, str(vid_frame)))
            plt.close()
