...
if __name__ == "__main__":
    ...
    _ = utils.project_via_PCA_hdf5(feats_fv, pca_fv, frame_ids, f'{out_path}/features_projected/fv/fv_repo_test{name_suffix}.npy')
    print(f'Saved projected features to {out_path}/features_projected/fv/fv_repo_test{name_suffix}.npy')

    print('Projecting thumbnail features via trained PCA model')
    _ = utils.project_via_PCA_hdf5(feats_thumb, pca_thumb, frame_ids, f'{out_path}/features_projected/thumb/thumb_repo_test{name_suffix}.npy')
    print(f'Saved projected features to {out_path}/features_projected/thumb/thumb_repo_test{name_suffix}.npy')

    print('Projecting VGG features via trained PCA model')
    _ = utils.project_via_PCA_hdf5(feats_vgg, pca_vgg, frame_ids, f'{out_path}/features_projected/vgg/vgg_repo_test{name_suffix}.npy')
    print(f'Saved projected features to {out_path}/features_projected/vgg/vgg_repo_test{name_suffix}.npy')
